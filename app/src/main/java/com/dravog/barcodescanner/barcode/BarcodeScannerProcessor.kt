...
package com.dravog.barcodescanner.barcode

import android.content.Context
import android.util.Log
import com.dravog.barcodescanner.GraphicOverlay
import com.dravog.barcodescanner.VisionProcessorBase
...
class BarcodeScannerProcessor(context: Context) :
    ...
    var bestSolution: MutableSet<String> = mutableSetOf()
    ...
    override fun onSuccess(results: List<Barcode>, graphicOverlay: GraphicOverlay) {
        ...
        bestSolution = bestSolution.plus(results.map { it.displayValue!! }) as MutableSet<String>
    }
        ...
        private fun logExtrasForTesting(barcode: Barcode?) {
            if (barcode != null) {
                Log.v(
                    MANUAL_TESTING_LOG,
                    String.format(
                        "Detected barcodes bounding box: %s",
